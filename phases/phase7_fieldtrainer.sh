...
# Branch name
echo ""
print_info "Common branches: main, master, develop, web_frontend"
read -p "Enter branch name to clone (default: $DEFAULT_BRANCH): " BRANCH_NAME

if [ -z "$BRANCH_NAME" ]; then
    BRANCH_NAME="$DEFAULT_BRANCH"
fi

print_info "Will clone branch: $BRANCH_NAME"
...
echo "Step 9: Service Configuration..."
echo "---------------------------------"
